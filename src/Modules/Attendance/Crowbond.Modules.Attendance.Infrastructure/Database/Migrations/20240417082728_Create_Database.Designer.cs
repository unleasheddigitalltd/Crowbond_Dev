...
namespace Crowbond.Modules.Attendance.Infrastructure.Database.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crowbond.Modules.Attendance.Domain.Attendees.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Crowbond.Modules.Attendance.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Crowbond.Modules.Attendance.Domain.Events.EventStatistics", b =>
                {
            ...
            modelBuilder.Entity("Crowbond.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Crowbond.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("Crowbond.Modules.Attendance.Domain.Attendees.Attendee", null)
                        .WithMany()
                    ...
                    b.HasOne("Crowbond.Modules.Attendance.Domain.Events.Event", null)
                        .WithMany()
