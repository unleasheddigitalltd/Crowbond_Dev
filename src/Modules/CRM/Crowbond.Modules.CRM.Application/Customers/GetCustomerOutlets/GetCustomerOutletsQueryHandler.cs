        ...
        const string sql =
            $"""
             SELECT
                 ...
                 s.full_name AS {nameof(CustomerOutletResponse.CustomerId)},
                 s.email AS {nameof(CustomerOutletResponse.CustomerId)},
                 s.phone_number AS {nameof(CustomerOutletResponse.CustomerId)},
                 s.mobile AS {nameof(CustomerOutletResponse.CustomerId)},
                 ...
                 s.delivery_note AS {nameof(CustomerOutletResponse.CustomerId)},
                 s.delivery_time_from AS {nameof(CustomerOutletResponse.CustomerId)},
                 s.delivery_time_to AS {nameof(CustomerOutletResponse.CustomerId)},
                 s.is24hrs_delivery AS {nameof(CustomerOutletResponse.CustomerId)}             
