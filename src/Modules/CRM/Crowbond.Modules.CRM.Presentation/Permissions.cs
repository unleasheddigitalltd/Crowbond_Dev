...
internal static class Permissions
{
    ...
    internal const string DeletCustomerProducts = "customers:products:delete";
    ...
    internal const string DeletCustomerProductBlacklist = "customers:product-blacklist:delete";
