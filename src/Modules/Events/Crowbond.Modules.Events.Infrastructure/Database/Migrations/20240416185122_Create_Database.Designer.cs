...
namespace Crowbond.Modules.Events.Infrastructure.Database.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crowbond.Modules.Events.Domain.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Crowbond.Modules.Events.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Crowbond.Modules.Events.Domain.TicketTypes.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Crowbond.Modules.Events.Domain.Events.Event", b =>
                {
                    b.HasOne("Crowbond.Modules.Events.Domain.Categories.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Crowbond.Modules.Events.Domain.TicketTypes.TicketType", b =>
                {
                    b.HasOne("Crowbond.Modules.Events.Domain.Events.Event", null)
                        .WithMany()
