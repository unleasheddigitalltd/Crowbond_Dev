...
internal sealed class GetOrdersByStatusQueryHandler(IDbConnectionFactory dbConnectionFactory)
    : IQueryHandler<GetOrdersByStatusQuery, OrdersResponse>
{
    public async Task<Result<OrdersResponse>> Handle(GetOrdersByStatusQuery request, CancellationToken cancellationToken)
    {
