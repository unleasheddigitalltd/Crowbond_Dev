...
internal sealed class PurchaseOrderApprovedDomainEventHandler(ISender sender, IEventBus eventBus)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await eventBus.PublishAsync(
            new PurchaseOrderApprovedIntegrationEvent(
                ...
                result.Value.Lines.Select(l => new PurchaseOrderApprovedIntegrationEvent.ReceiptLine(
