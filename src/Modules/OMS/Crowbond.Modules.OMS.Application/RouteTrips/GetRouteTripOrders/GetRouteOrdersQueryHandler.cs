    ...
    public async Task<Result<IReadOnlyCollection<OrderResponse>>> Handle(GetRouteTripOrdersQuery request, CancellationToken cancellationToken)
    {
        ...
        const string sql =
             ...
             SELECT
                ...
                delivery_address_town_city AS {nameof(OrderResponse.DeliveryAddressTownCity)},
                delivery_address_county AS {nameof(OrderResponse.DeliveryAddressCounty)},
                delivery_address_postal_code AS {nameof(OrderResponse.DeliveryAddressPostalCode)},
