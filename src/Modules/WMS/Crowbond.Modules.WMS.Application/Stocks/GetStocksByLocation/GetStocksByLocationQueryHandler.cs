...
internal sealed class GetStocksByLocationQueryHandler(IDbConnectionFactory dbConnectionFactory)
    : IQueryHandler<GetStocksByLocationQuery, IReadOnlyCollection<StockResponse>>
{
    public async Task<Result<IReadOnlyCollection<StockResponse>>> Handle(GetStocksByLocationQuery request, CancellationToken cancellationToken)
    {
