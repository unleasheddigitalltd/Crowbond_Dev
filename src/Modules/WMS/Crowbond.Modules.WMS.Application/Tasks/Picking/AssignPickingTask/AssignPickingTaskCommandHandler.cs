...
internal sealed class AssignPickingTaskCommandHandler(
    ITaskRepository taskRepository,
    IDispatchRepository dispatchRepository,
    IUnitOfWork unitOfWork)
    : ICommandHandler<AssignPickingTaskCommand, Guid>
{
    public async Task<Result<Guid>> Handle(AssignPickingTaskCommand request, CancellationToken cancellationToken)
    {
