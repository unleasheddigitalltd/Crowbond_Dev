...
internal sealed class QuitPutAwayTaskCommandHandler(
    ITaskRepository taskRepository,
    IDateTimeProvider dateTimeProvider,
    IUnitOfWork unitOfWork)
    : ICommandHandler<QuitPutAwayTaskCommand>
{
    public async Task<Result> Handle(QuitPutAwayTaskCommand request, CancellationToken cancellationToken)
    {
