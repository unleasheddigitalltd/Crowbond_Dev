...
public static class ProductErrors
{
    ...
    Error.NotFound("Products.NotFound", $"The filter type with the name {filterTypeName} was not found");

    public static Error InventoryTypeNotFound(string inventoryTypeName
        ) =>
    Error.NotFound("Products.NotFound", $"The inventory type with the name {inventoryTypeName} was not found");

    public static Error UnitOfMeasureNotFound(string unitOfMeasurName) =>
    Error.NotFound("Products.NotFound", $"The unit of measure with the name {unitOfMeasurName} was not found");
