...
namespace Crowbond.Modules.WMS.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240926140759_Remove_Receipt_CreatedBy")]
    partial class Remove_Receipt_CreatedBy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Products.Product", b =>
                {
                    ...
                    b.HasIndex("ProductGroupName")
                        .HasDatabaseName("ix_products_product_group_name");
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Products.Product", b =>
                {
                    b.HasOne("Crowbond.Modules.WMS.Domain.Products.Brand", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_products_brands_brand_name");
                    ...
                    b.HasOne("Crowbond.Modules.WMS.Domain.Products.Category", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_products_categories_category_name");
                    ...
                    b.HasOne("Crowbond.Modules.WMS.Domain.Products.ProductGroup", null)
                        .WithMany()
                        .HasForeignKey("ProductGroupName")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_products_product_groups_product_group_name");
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskHeader", b =>
                {
                    b.HasOne("Crowbond.Modules.WMS.Domain.Dispatches.DispatchHeader", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_headers_dispatch_headers_entity_id");
