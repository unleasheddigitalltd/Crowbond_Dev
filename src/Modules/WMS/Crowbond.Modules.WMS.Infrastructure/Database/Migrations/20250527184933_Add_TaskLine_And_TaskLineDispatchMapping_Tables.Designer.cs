...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_task_lines");

                    b.HasIndex("TaskHeaderId")
                        .HasDatabaseName("ix_task_lines_task_header_id");

                    b.ToTable("task_lines", "wms");
                });

            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskLineDispatchMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("TaskLineId")
                        .HasColumnType("uuid")
                        .HasColumnName("task_line_id");

                    b.HasKey("Id")
                        .HasName("pk_task_line_dispatch_mappings");

                    b.HasIndex("DispatchLineId")
                        .IsUnique()
                        .HasDatabaseName("ix_task_line_dispatch_mappings_dispatch_line_id");

                    b.HasIndex("TaskLineId")
                        .HasDatabaseName("ix_task_line_dispatch_mappings_task_line_id");

                    b.ToTable("task_line_dispatch_mappings", "wms");
                });
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskAssignment", b =>
                {
                    ...
                    b.HasOne("Crowbond.Modules.WMS.Domain.Tasks.TaskHeader", "Header")
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskAssignmentLine", b =>
                {
                    ...
                    b.HasOne("Crowbond.Modules.WMS.Domain.Tasks.TaskAssignment", "Assignment")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskLine", b =>
                {
                    b.HasOne("Crowbond.Modules.WMS.Domain.Tasks.TaskHeader", "TaskHeader")
                        .WithMany("Lines")
                        .HasForeignKey("TaskHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_lines_task_headers_task_header_id");
            ...
            modelBuilder.Entity("Crowbond.Modules.WMS.Domain.Tasks.TaskLineDispatchMapping", b =>
                {
                    b.HasOne("Crowbond.Modules.WMS.Domain.Tasks.TaskLine", "TaskLine")
                        .WithMany("DispatchMappings")
                        .HasForeignKey("TaskLineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_line_dispatch_mappings_task_lines_task_line_id");
